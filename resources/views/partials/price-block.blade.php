  ...
  <div class="container">
    ...
    <div class="price-block__wrap">
      ...
      @foreach( $goods as $post )
        ...
        <div class="price-block__item good-@php the_ID() @endphp">
          ...
          <form action="" class="price-block__form">
            ...
            <input type="text" class="price-block__form-item input" placeholder="Имя">
            ...
            <input type="submit" value="Оформить заказ" class="price-block__submit button">
          </form>
        </div>
      @endforeach
