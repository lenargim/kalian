    ...
    <div class="steps__wrap">
      ...
      <div class="steps__item">
        ...
        <div class="steps__text">Вы определяетесь
          ...
          <span style="white-space: nowrap">а Кальянщик готовит</span> необходимое количество забивок
        </div>
      </div>
      <div class="steps__item">
      ...
      <div class="steps__item">
        ...
        <div class="steps__text">Последующие забивки Вы самостоятельно меняете, разогревая угольки на плитке, которую мы
          тоже Вам оставляем
        </div>
      </div>
      <div class="steps__item">
